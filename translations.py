...
for i, (q_en, a_en, q_ru, a_ru, q_hy, a_hy) in enumerate([
    ...
    ("How do I view my saved addresses?", "Press 'My Addresses' in the menu.", "Как посмотреть мои адреса?", "Նажмите 'Мои адреса' в меню.", "Ինչպե՞ս տեսնել իմ հասցեները։", "Մենյուում սեղմեք «Իմ հասցեները»։"),
    ...
    ("How do I disable silent mode?", "Go to silent mode settings and turn it off.", "Как отключить тихий режим?", "Откройте настройки тихого режима и отключите его.", "Ինչպե՞ս անջատել լուռ ռեժիմը։", "Բացեք լուռ ռեժիմի կարգավորումները և անջատեք այն։"),
    ("How do I get statistics about outages?", "Use the 'Statistics' command in the menu.", "Как получить статистику по отключениям?", "Используйте команду 'Статистика' в меню.", "Ինչպե՞ս ստանալ անջատումների վիճակագրություն։", "Օգտագործեք «Վիճակագրություն» հրամանը մենյուում։"),
    ...
    ("How do I set a default address?", "Currently, the first address is used as default.", "Как установить адрес по умолчанию?", "Сейчас первым добавленным адресом считается адрес по умолчанию.", "Ինչպե՞ս սահմանել հիմնական հասցե։", "Ներկայումս առաջին ավելացված հասցեն համարվում է հիմնական։"),
