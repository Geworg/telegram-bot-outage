...
CONTACT_PHONE_NUMBER = "+374123456"
...
# MAP_URL = f"https://maps.app.goo.gl/xoyewDMqmqsRWPJK9"
CLICKABLE_PHONE_MD = f"📞 [{CONTACT_PHONE_NUMBER}](tel:{CONTACT_PHONE_NUMBER.replace(' ', '')})" # Убираем пробелы из tel: ссылки
...
translations = {
    ...
    "set_frequency_btn": {"hy": "⏱️ Սահմանել հաճախականությունը", "ru": "⏱️ Уст. частоту", "en": "⏱️ Set Frequency"},
    ...
    "choose_region_prompt": {"hy": "Ընտրեք մարզը/շրջանը:", "ru": "Выберите область/район:", "en": "Select the region/district:"},
    "no_regions_configured": {"hy": "Ցավում ենք, մարզեր դեռ կազմաձևված չեն։", "ru": "К сожалению, области пока не настроены.", "en": "Sorry, regions are not configured yet."},
    "enter_street_prompt": {"hy": "{region} մարզ։\nԽնդրում ենք մուտքագրել փողոցի անունը:", "ru": "Область: {region}.\nПожалуйста, введите название улицы:", "en": "Region: {region}.\nPlease enter the street name:"},
    ...
    "error_region_not_selected": {"hy": "Սխալ։ Մարզը ընտրված չէ։ Խնդրում ենք նորից փորձել։", "ru": "Ошибка: Область не выбрана. Пожалуйста, попробуйте снова.", "en": "Error: Region not selected. Please try again."},
    ...
    "please_try_again_street": {"hy": "Խնդրում ենք փորձել մուտքագրել փողոցը նորից, գուցե ավելի մանրամասն։", "ru": "Пожалуйста, попробуйте ввести улицу еще раз, возможно, более подробно.", "en": "Please try entering the street again, perhaps with more detail."},
    ...
    "error_generic_try_again": {"hy": "Տեղի է ունեցել սխալ։ Խնդրում ենք փորձել մի փոքր ուշ։", "ru": "Произошла ошибка. Пожалуйста, попробуйте немного позже.", "en": "An error occurred. Please try again later."},
    ...
    "error_invalid_selection": {"hy": "Սխալ ընտրություն։", "ru": "Неверный выбор.", "en": "Invalid selection."},
    ...
    "help_btn": {"hy": "ℹ️ Օգնություն", "ru": "ℹ️ Помощь", "en": "ℹ️ Help"},
    ...
    "help_text_detailed": {
        "hy": (
            ...
            "• `🔍 Ստուգել հասցեն` - Անմիջապես ստուգել անջատումները որոշակի հասցեում (շուտով)\n"
            ...
            "• `⭐ Բաժանորդագրություն` - Կառավարել ձեր բաժանորդագրության պլանը (շուտով)\n"
            "• `📊 Վիճակագրություն` - Ցուցադրել բոտի և ձեր անձնական վիճակագրությունը (շուտով)\n\n"
        ...
        "en": (
            ...
            "• `🔍 Check address` - Instantly check for outages on a specific address (soon)\n"
            ...
            "• `⭐ Subscription` - Manage your subscription plan (soon)\n"
            "• `📊 Statistics` - Show bot statistics and your personal stats (soon)\n\n"
            "If you have questions, you can contact us:\n"
            f"{CLICKABLE_PHONE_MD}\n"
            f"{CLICKABLE_ADDRESS_MD}"
        )
    },
    "unknown_command": {"hy": "Չհասկացա հրամանը։ 🤔\nՓորձեք օգտագործել կոճակները կամ /help հրամանը։", "ru": "Неизвестная команда. 🤔\nПопробуйте использовать кнопки или команду /help.", "en": "Unknown command. 🤔\nTry using the buttons or the /help command."},
    "unknown_command_short": {"hy": "🤔", "ru": "🤔", "en": "🤔"},
    ...
    "premium_required_for_frequency": {"hy": "Այս հաճախականությունը պահանջում է ավելի բարձր բաժանորդագրության մակարդակ։", "ru": "Эта частота требует более высокого уровня подписки.", "en": "This frequency requires a higher subscription tier."},
    "invalid_frequency_option": {"hy": "Սխալ հաճախականության ընտրություն։", "ru": "Неверный выбор частоты.", "en": "Invalid frequency option."},
    ...
    "sound_notifications_btn": {"hy": "🎵 Ձայնային ծանուցումներ", "ru": "🎵 Звуковые уведомления", "en": "🎵 Sound Notifications"},
    ...
    "back_to_main_menu_btn": {"hy": "⬅️ Հիմնական մենյու", "ru": "⬅️ Главное меню", "en": "⬅️ Main Menu"},
    "choose_language_prompt": {"hy": "Ընտրեք լեզուն:", "ru": "Выберите язык:", "en": "Select language:"},
    "choose_language_prompt_button": {"hy": "Խնդրում ենք ընտրել նոր լեզուն՝ օգտագործելով ներքևի կոճակները:", "ru": "Пожалуйста, выберите новый язык, используя кнопки ниже:", "en": "Please select your new language using the buttons below:"},
    "choose_language_initial_prompt": {"hy": "Խնդրում ենք ընտրել ձեր նախընտրած լեզուն շարունակելու համար:", "ru": "Пожалуйста, выберите предпочитаемый язык для продолжения:", "en": "Please select your preferred language to continue:"},
    ...
    "choose_region_for_check": {"hy": "🔍 Ստուգելու համար ընտրեք տարածաշրջանը։", "ru": "🔍 Для проверки выберите регион:", "en": "🔍 Choose region to check:"}, # Пункт 2
    ...
    "enter_street_for_check": {"hy": "🔍 Ստուգելու համար մուտքագրեք փողոցի անունը։", "ru": "🔍 Для проверки введите название улицы:", "en": "🔍 To check, enter the street name:"}, # Пункт 2
    ...
    "welcome": {"hy": "Ողջույն, {name} 👋 Ես CheckSiteUpdateBot-ն եմ, պատրաստ ենք օգնել ձեզ տեղեկացված մնալ կոմունալ անջատումների մասին:", "ru": "Привет, {name} 👋 Я CheckSiteUpdateBot, готов помочь вам оставаться в курсе отключений коммунальных услуг!", "en": "Hello, {name} 👋 I'm CheckSiteUpdateBot, ready to help you stay informed about utility outages!"},
    ...
    "no_save_original": {"hy": "Ոչ, պահպանել իմ տարբերակը", "ru": "Нет, сохранить мою версию", "en": "No, save my version"}, # Пункт 6а
    ...
    "error_generic_admin": {"hy": "Տեղի է ունեցել համակարգային սխալ: Խնդրում ենք տեղեկացնել ադմինիստրատորին:", "ru": "Произошла системная ошибка. Пожалуйста, сообщите администратору.", "en": "A system error occurred. Please inform the administrator."}, # Пункт 5
    ...
    "error_region_not_selected": {"hy": "Տարածաշրջանն ընտրված չէ։ Խնդրում ենք նորից փորձել հասցեի ավելացումը։", "ru": "Регион не выбран. Пожалуйста, попробуйте добавить адрес снова.", "en": "Region not selected. Please try adding the address again."},
    "error_region_not_selected_for_check": {"hy": "Ստուգման համար տարածաշրջանն ընտրված չէ։ Խնդրում ենք նորից փորձել։", "ru": "Регион для проверки не выбран. Пожалуйста, попробуйте снова.", "en": "Region for check not selected. Please try again."}, # Пункт 2
    "error_confirmation_timeout": {"hy": "Հաստատման սխալ (հնարավոր է ժամանակի սպառում): Խնդրում ենք նորից փորձել հասցեի ավելացումը:", "ru": "Ошибка подтверждения (возможно, истекло время). Пожалуйста, попробуйте добавить адрес снова.", "en": "Confirmation error (possibly timed out). Please try adding the address again."}, # Пункт 6а
    "error_final_street_empty": {"hy": "Չհաջողվեց որոշել փողոցը: Խնդրում ենք նորից փորձել:", "ru": "Не удалось определить улицу. Пожалуйста, попробуйте снова.", "en": "Failed to determine street. Please try again."}, # Пункт 6а
    ...
    "use_inline_buttons_for_subscription": {"hy": "Խնդրում ենք օգտագործել հաղորդագրության տակի կոճակները՝ բաժանորդագրությունն ընտրելու համար։", "ru": "Пожалуйста, используйте кнопки под сообщением для выбора подписки.", "en": "Please use the buttons under the message to choose a subscription."},
    ...
    "command_start_description": {"hy": "Սկսել / Գլխավոր մենյու", "ru": "Старт / Главное меню", "en": "Start / Main menu"},
    ...
    "address_clarifying_ai": {"hy": "Ստուգում ենք հասցեն բանականության միջոցով... 🤖", "ru": "Проверяю адрес с помощью ИИ... 🤖", "en": "Checking address with AI... 🤖"},
    ...
    "address_clarification_cancelled": {"hy": "Հասցեի ավելացումը չեղարկված է։ Խնդրում ենք, փորձեք նորից կամ մուտքագրեք ավելի ճշգրիտ։", "ru": "Добавление адреса отменено. Пожалуйста, попробуйте снова или введите более точно.", "en": "Address addition cancelled. Please try again or enter more precisely."},
    ...
    "help_text_main": {
        "hy": (
            ...
            "• **🧹 Մաքրել բոլորը** \\- Հեռացնել ձեր բոլոր հասցեները:\n"
            "• **🔍 Ստուգել հասցեն** \\- Անմիջապես ստուգել տվյալ հասցեում անջատումների առկայությունը:\n"
            "• **⚙️ Փոխել լեզուն** \\- Ընտրել բոտի ինտերֆեյսի լեզուն \\(Հայերեն, Русский, English\\):\n"
            "• **⏱️ Սահմանել հաճախականությունը** \\- Սահմանել, թե որքան հաճախ բոտը պետք է ստուգի թարմացումները:\n"
        ...
        "ru": (
            ...
            "• **➕ Добавить адрес** \\- Добавить новый адрес для отслеживания\\.\n"
            "• **➖ Удалить адрес** \\- Удалить ранее добавленный адрес\\.\n"
            "• **📋 Показать адреса** \\- Показать все ваши добавленные адреса\\.\n"
            "• **🧹 Очистить всё** \\- Удалить все ваши адреса\\.\n"
            "• **🔍 Проверить адрес** \\- Моментально проверить наличие отключений для адреса\\.\n"
            "• **⚙️ Изменить язык** \\- Выбрать язык интерфейса бота \\(Հայերեն, Русский, English\\)\\.\n"
            "• **⏱️ Установить частоту** \\- Установить, как часто бот должен проверять обновления\\.\n"
