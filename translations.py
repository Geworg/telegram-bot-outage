...
translations["qa_btn"] = {"hy": "💬 Հարց ու պատասխան և աջակցություն", "ru": "💬 Вопрос-ответ и поддержка", "en": "💬 Q&A and Support"}
...
translations["cmd_qa"] = {"hy": "Հարց ու պատասխան և աջակցություն", "ru": "Вопрос-ответ и поддержка", "en": "Q&A and Support"}
...
translations["menu_message"] = {"hy": "📋 Դուք գտնվում եք գլխավոր ցանկում։ Խնդրում ենք ընտրել գործողություն՝ օգտագործելով կոճակներ կամ հրամաններ։ Եթե ունեք ​​դժվարություններ կամ չեք հասկանում միջերեսը, սեղմեք «Հարցեր ու պատասխաններ և աջակցություն» կոճակը կամ ուղարկեք /qa հրամանը չատում։",
                                "ru": "📋 Вы находитесь в главном меню. Пожалуйста, выберите действие с помощью кнопок или команд. Если возникли трудности или непонимание интерфейса, нажмите кнопку „Вопрос–ответ и поддержка“ или отправьте команду /qa в чат.",
                                "en": "📋 You are in the main menu. Please select an action using buttons or commands. If you have any difficulties or do not understand the interface, click the 'Q&A and Support' button or send the /qa command in the chat."}
...
translations["enter_street"] = {"hy": "Ընտրված է {region}։\nԱյժմ մուտքագրեք ձեր փողոցի և շենքի համարը (օրինակ՝ Աբովյանի փողոց, 5)․", "ru": "Выбрано: {region}.\nТеперь введите улицу и номер дома (например: улица Абовяна, 5):", "en": "Selected: {region}.\nNow, enter your street and house number (e.g., Abovyan Street, 5):"}
