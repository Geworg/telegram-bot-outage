...
translations = {
    ...
    # --- Language Selection ---
    "initial_language_prompt": {"hy": "Խնդրում ենք ընտրել բոտի լեզուն՝ օգտագործելով ստորև տրված կոճակները։", "ru": "Пожалуйста, выберите язык бота, используя кнопки ниже.", "en": "Please select the bot's language using the buttons below."},
    ...
    # --- Address Management ---
    "choose_region": {"hy": "Ընտրեք մարզը կամ Երևան քաղաքը:", "ru": "Выберите область или город Ереван:", "en": "Choose region or city Yerevan:"},
    ...
    "confirm_silent_mode_period": {"hy": "Ցանկանու՞մ եք լուռ ռեժիմը սահմանել {start} - {end} ժամանակահատվածի համար:", "ru": "Вы хотите установить тихий режим с {start} до {end}?", "en": "Would you like to set silent mode from {start} to {end}?"},
    "no_edit": {"hy": "📝 Խմբագրել", "ru": "📝 Изменить", "en": "📝 Edit"},
}