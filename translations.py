...
translations["sound_btn"] = {"hy": "🎵 Ձայնի կարգավորումներ", "ru": "🎵 Настройки звука", "en": "🎵 Sound Settings"}
...
translations["menu_message"] = {"hy": "Գլխավոր մենյու․", "ru": "Главное меню:", "en": "Main menu:"}
...
translations["unknown_command"] = {"hy": "Անհայտ հրաման։ Օգտվեք կոճակներից։", "ru": "Неизвестная команда. Воспользуйтесь кнопками.", "en": "Unknown command. Please use the buttons."}
...
translations["change_language_prompt"] = {"hy": "Ընտրեք նոր լեզուն:", "ru": "Выберите новый язык:", "en": "Choose the new language:"}
translations["language_set_success"] = {"hy": "Լեզուն փոխված է հայերենի։", "ru": "Язык изменён на русский.", "en": "Language changed to English."}

# --- Address Management ---
translations["choose_region"] = {"hy": "Ընտրեք մարզը կամ Երևան քաղաքը:", "ru": "Выберите область или город Еревան:", "en": "Choose region or city Yerevan:"}
...
translations["address_not_found_yandex"] = {"hy": "Ցավոք, չհաջողվեց գտնել այդպիսի հասցե։ Խնդրում եմ, փորձեք նորից՝ ավելի ճշգրիտ մուտքագրելով։", "ru": "К сожалению, не удалось найти такой адрес. Пожалуйста, попробуйте снова, введя его точнее.", "en": "Sorry, that address could not be found. Please try again with a more precise entry."}
...
translations["outage_check_on_add_title"] = {"hy": "🔍 *Արագ ստուգում նոր հասցեի համար...*", "ru": "🔍 *Быстрая проверка для нового адреса...*", "en": "🔍 *Quick check for new address...*"}
...
translations["frequency_current"] = {"hy": "Ընթացիկ՝", "ru": "Текущая:", "en": "Current:"}
...
# --- Sound Settings ---
translations["sound_settings_title"] = {"hy": "🎵 Ձայնի կարգավորումներ", "ru": "🎵 Настройки звука", "en": "🎵 Sound Settings"}
translations["sound_toggle_on"] = {"hy": "🔊 Միացնել բոլոր ձայները", "ru": "🔊 Включить все звуки", "en": "🔊 Enable All Sounds"}
translations["sound_toggle_off"] = {"hy": "🔇 Անջատել բոլոր ձայները", "ru": "🔇 Выключить все звуки", "en": "🔇 Disable All Sounds"}
translations["sound_on_status"] = {"hy": "Հիմնական ձայնը՝ ✅ Միացված", "ru": "Основной звук: ✅ Включен", "en": "Main Sound: ✅ Enabled"}
translations["sound_off_status"] = {"hy": "Հիմնական ձայնը՝ ❌ Անջատված", "ru": "Основной звук: ❌ Выключен", "en": "Main Sound: ❌ Disabled"}
translations["silent_mode_toggle_on"] = {"hy": "🌙 Միացնել լուռ ռեժիմը", "ru": "🌙 Включить тихий режим", "en": "🌙 Enable Silent Mode"}
translations["silent_mode_toggle_off"] = {"hy": "☀️ Անջատել լուռ ռեժիմը", "ru": "☀️ Выключить тихий режим", "en": "☀️ Disable Silent Mode"}
translations["silent_mode_on_status"] = {"hy": "Լուռ ռեժիմ՝ ✅ {start} - {end}", "ru": "Тихий режим: ✅ {start} - {end}", "en": "Silent Mode: ✅ {start} - {end}"}
translations["silent_mode_off_status"] = {"hy": "Լուռ ռեժիմ՝ ❌ Անջատված", "ru": "Тихий режим: ❌ Выключен", "en": "Silent Mode: ❌ Disabled"}
translations["enter_silent_interval_prompt"] = {"hy": "Մուտքագրեք լուռ ռեժիմի ժամանակահատվածը (օրինակ՝ 23:00-07:00)։", "ru": "Введите интервал тихого режима (например, 23:00-07:00):", "en": "Enter the silent mode interval (e.g., 23:00-07:00):"}
translations["invalid_time_interval"] = {"hy": "❌ Սխալ ձևաչափ։ Խնդրում եմ մուտքագրել «ժժ:րր-ժժ:րր» տեսքով։", "ru": "❌ Неверный формат. Пожалуйста, введите в виде «ЧЧ:ММ-ЧЧ:ММ».", "en": "❌ Invalid format. Please enter as 'HH:MM-HH:MM'."}
translations["silent_interval_set"] = {"hy": "✅ Լուռ ռեժիմի ժամանակահատվածը սահմանված է։", "ru": "✅ Интервал тихого режима установлен.", "en": "✅ Silent mode interval has been set."}

# --- Q&A and Support ---
translations["qa_title"] = {"hy": "💬 Հաճախ տրվող հարցեր", "ru": "💬 Часто задаваемые вопросы", "en": "💬 Frequently Asked Questions"}
translations["qa_placeholder_q1"] = {"hy": "Հարց 1։ Ինչպե՞ս ավելացնել հասցե։", "ru": "Вопрос 1: Как добавить адрес?", "en": "Question 1: How do I add an address?"}
translations["qa_placeholder_a1"] = {"hy": "Պատասխան 1։ Սեղմեք «Ավելացնել հասցե» կոճակը։", "ru": "Ответ 1: Нажмите кнопку «Добавить адрес».", "en": "Answer 1: Press the 'Add Address' button."}
translations["qa_placeholder_q2"] = {"hy": "Հարց 2։ Որքա՞ն հաճախ են ստուգվում կայքերը։", "ru": "Вопрос 2: Как часто проверяются сайты?", "en": "Question 2: How often are the sites checked?"}
translations["qa_placeholder_a2"] = {"hy": "Պատասխան 2։ Դա կախված է ձեր ընտրած հաճախականությունից։", "ru": "Ответ 2: Это зависит от выбранной вами частоты.", "en": "Answer 2: It depends on your chosen frequency."}
translations["support_btn"] = {"hy": "✉️ Գրել սպասարկման կենտրոն", "ru": "✉️ Написать в поддержку", "en": "✉️ Write to Support"}
translations["support_prompt"] = {"hy": "Խնդրում եմ մուտքագրեք ձեր հաղորդագրությունը սպասարկման կենտրոնի համար։ Ադմինիստրատորը կստանա այն և կպատասխանի ձեզ հնարավորինս շուտ։", "ru": "Пожалуйста, введите ваше сообщение для службы поддержки. Администратор получит его и свяжется с вами в ближайшее время.", "en": "Please enter your message for the support team. The administrator will receive it and get back to you as soon as possible."}
