...
CLICKABLE_PHONE_MD = f"📞 [{CONTACT_PHONE_NUMBER}](tel:{CONTACT_PHONE_NUMBER.replace('+37477123456')})"
...
translations = {
    ...
    "choose_language_inline": {"hy": "Ընտրեք ձեր նախընտրած լեզուն:", "ru": "Выберите предпочитаемый язык:", "en": "Please choose your preferred language:"},
    ...
    "help_text_main": {
        "hy": (
            ...
            "**Հիմնական հրահանգներ:**\n"
            "• `/start` \\- Սկսել աշխատանքը բոտի հետ:\n"
